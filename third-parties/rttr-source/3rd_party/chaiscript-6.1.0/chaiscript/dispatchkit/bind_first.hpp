...
auto bind_first(Ret (*f)(P1, Param...), O&& o) {
    return [f, o](Param... param) -> Ret { return f(std::forward<O>(o), std::forward<Param>(param)...); };
}

template <typename O, typename Ret, typename Class, typename... Param>
auto bind_first(Ret (Class::*f)(Param...), O&& o) {
    return [f, o](Param... param) -> Ret { return (get_pointer(o)->*f)(std::forward<Param>(param)...); };
}
...
auto bind_first(const std::function<Ret(P1, Param...)>& f, O&& o) {
    return [f, o](Param... param) -> Ret { return f(o, std::forward<Param>(param)...); };
}
...
auto bind_first(const F& fo, O&& o, Ret (Class::*f)(P1, Param...) const) {
    return [fo, o, f](Param... param) -> Ret { return (fo.*f)(o, std::forward<Param>(param)...); };
}
