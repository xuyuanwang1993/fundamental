...
private:
    static Boxed_Value from_json(const json::JSON& t_json) {
        ...
        case json::JSON::Class::Null: return Boxed_Value();
        ...
        case json::JSON::Class::String: return Boxed_Value(t_json.to_string());
        case json::JSON::Class::Floating: return Boxed_Value(t_json.to_float());
        case json::JSON::Class::Integral: return Boxed_Value(t_json.to_int());
        case json::JSON::Class::Boolean: return Boxed_Value(t_json.to_bool());
        }
    ...
    static json::JSON to_json_object(const Boxed_Value& t_bv) {
        try {
            const std::map<std::string, Boxed_Value> m =
                chaiscript::boxed_cast<const std::map<std::string, Boxed_Value>&>(t_bv);
