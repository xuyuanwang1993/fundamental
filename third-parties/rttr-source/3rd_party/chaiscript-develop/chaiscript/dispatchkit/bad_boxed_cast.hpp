...
public:
    bad_boxed_cast(Type_Info t_from, const std::type_info& t_to, std::string t_what) noexcept :
    ...
    explicit bad_boxed_cast(std::string t_what) noexcept : m_what(std::move(t_what)) {
    }
