...
struct Bare_Type {
    typedef
        typename std::remove_cv<typename std::remove_pointer<typename std::remove_reference<T>::type>::type>::type type;
};
} // namespace detail
...
public:
    ...
    m_type_info(t_ti),
    m_bare_type_info(t_bare_ti), m_flags((static_cast<unsigned int>(t_is_const) << is_const_flag) +
...
struct Get_Type_Info {
    static constexpr Type_Info get() {
        return Type_Info(
            ...
            std::is_reference<T>::value, std::is_pointer<T>::value, std::is_void<T>::value,
...
struct Get_Type_Info<std::shared_ptr<T>> {
    ...
    static constexpr Type_Info get() {
        return Type_Info(
            std::is_const<T>::value, std::is_reference<T>::value, std::is_pointer<T>::value, std::is_void<T>::value,
...
struct Get_Type_Info<const std::shared_ptr<T>&> {
    static constexpr Type_Info get() {
        return Type_Info(
            ...
            std::is_arithmetic<T>::value &&
                !std::is_same<typename std::remove_const<typename std::remove_reference<T>::type>::type, bool>::value,
            &typeid(const std::shared_ptr<T>&), &typeid(typename Bare_Type<T>::type));
    }
};
...
struct Get_Type_Info<std::reference_wrapper<T>> {
    static constexpr Type_Info get() {
        return Type_Info(
            ...
            std::is_arithmetic<T>::value &&
                !std::is_same<typename std::remove_const<typename std::remove_reference<T>::type>::type, bool>::value,
            &typeid(std::reference_wrapper<T>), &typeid(typename Bare_Type<T>::type));
    }
};
...
struct Get_Type_Info<const std::reference_wrapper<T>&> {
    static constexpr Type_Info get() {
        return Type_Info(
            ...
            std::is_arithmetic<T>::value &&
                !std::is_same<typename std::remove_const<typename std::remove_reference<T>::type>::type, bool>::value,
            &typeid(const std::reference_wrapper<T>&), &typeid(typename Bare_Type<T>::type));
    }
};
