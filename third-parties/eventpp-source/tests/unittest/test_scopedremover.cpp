...
TEST_CASE("ScopedRemover, EventDispatcher") {
...

    {
        ...
        r1.prependListener(event, [&dataList]() { ++dataList[1]; });
        {
            Remover r2(dispatcher);
            auto handle = r2.appendListener(event, [&dataList]() { ++dataList[2]; });
            {
                Remover r3(dispatcher);
                r3.insertListener(
                    event, [&dataList]() { ++dataList[3]; }, handle);
                {
                    r4.setDispatcher(dispatcher);
                    r4.appendListener(event, [&dataList]() { ++dataList[4]; });
...
TEST_CASE("ScopedRemover, CallbackList") {
...

    {
        ...
        r1.prepend([&dataList]() { ++dataList[1]; });
        {
            Remover r2(callbackList);
            auto handle = r2.append([&dataList]() { ++dataList[2]; });
            {
                Remover r3(callbackList);
                r3.insert([&dataList]() { ++dataList[3]; }, handle);
                {
                    r4.setCallbackList(callbackList);
                    r4.append([&dataList]() { ++dataList[4]; });
...
TEST_CASE("ScopedRemover, EventDispatcher, move assignment") {
...

    {
        ...
        {
            Remover r1(dispatcher);
            r1.appendListener(event, [&dataList]() { ++dataList[1]; });
            dispatcher.dispatch(event);
...
TEST_CASE("ScopedRemover, EventDispatcher, swap") {
    ...
    r2.appendListener(event, [&dataList]() { ++dataList[2]; });
    swap(r1, r2);
    r2.reset();
    dispatcher.dispatch(event);
...
TEST_CASE("ScopedRemover, EventDispatcher, removeListener") {
    ...
    hb = dispatcher.appendListener(event, [&dataList]() { ++dataList[1]; });
    hc = remover.appendListener(event, [&dataList]() { ++dataList[2]; });
...
TEST_CASE("ScopedRemover, CallbackList, remove") {
    ...
    hb = callbackList.append([&dataList]() { ++dataList[1]; });
    hc = remover.append([&dataList]() { ++dataList[2]; });
