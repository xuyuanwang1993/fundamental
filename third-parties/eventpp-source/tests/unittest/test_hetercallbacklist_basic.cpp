...
TEST_CASE("HeterCallbackList, append") {
    ...
    callbackList.append([&orderList, &order]() { orderList[order++] = 1; });
    callbackList.append([&orderList, &order]() { orderList[order++] = 2; });
    callbackList.append([&orderList, &order](int) { orderList[order++] = 3; });
    callbackList.append([&orderList, &order](int) { orderList[order++] = 4; });
    callbackList.append([&orderList, &order](int) { orderList[order++] = 5; });
...
TEST_CASE("HeterCallbackList, prepend") {
    ...
    callbackList.prepend([&orderList, &order]() { orderList[order++] = 1; });
    callbackList.prepend([&orderList, &order]() { orderList[order++] = 2; });
    callbackList.prepend([&orderList, &order](int) { orderList[order++] = 3; });
    callbackList.prepend([&orderList, &order](int) { orderList[order++] = 4; });
    callbackList.prepend([&orderList, &order](int) { orderList[order++] = 5; });
...
TEST_CASE("HeterCallbackList, insert") {
    ...
    auto h1 = callbackList.append([&orderList, &order]() { orderList[order++] = 1; });
    callbackList.insert([&orderList, &order]() { orderList[order++] = 2; }, h1);

    auto h2 = callbackList.append([&orderList, &order](int) { orderList[order++] = 3; });
    callbackList.insert([&orderList, &order](int) { orderList[order++] = 4; }, h2);
    ...
    ++h2.index;
    callbackList.insert([&orderList, &order](int) { orderList[order++] = 5; }, h2);
...
TEST_CASE("HeterCallbackList, remove") {
    ...
    auto h1 = callbackList.append([&dataList]() { ++dataList[0]; });
    auto h2 = callbackList.append([&dataList]() { ++dataList[1]; });
    auto h3 = callbackList.append([&dataList](int) { ++dataList[2]; });
    auto h4 = callbackList.append([&dataList](int) { ++dataList[3]; });
    auto h5 = callbackList.append([&dataList](int) { ++dataList[4]; });
...
TEST_CASE("HeterCallbackList, forEachIf") {
    ...
    callbackList.append([&dataListNoArg]() { dataListNoArg[0] += 1; });
    callbackList.append([&dataListNoArg]() { dataListNoArg[1] += 2; });
    callbackList.append([&dataListNoArg]() { dataListNoArg[2] += 3; });

    callbackList.append([&dataListWithArg](int n) { dataListWithArg[0] += n; });
    callbackList.append([&dataListWithArg](int n) { dataListWithArg[1] += n * 2; });
    callbackList.append([&dataListWithArg](int n) { dataListWithArg[2] += n * 3; });
...
TEST_CASE("HeterCallbackList, prototype convert") {
    ...
    callbackList.append([&dataList](int) { ++dataList[0]; });
    callbackList.append([&dataList](const MyClass&) { ++dataList[1]; });
