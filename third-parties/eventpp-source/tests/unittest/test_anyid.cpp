...
TEST_CASE("AnyId, default, unordered_map") {
    ...
    eventQueue.appendListener(3, [&dataList]() { ++dataList[0]; });
    eventQueue.appendListener(std::string("hello"), [&dataList]() { ++dataList[1]; });
    eventQueue.appendListener(std::vector<bool> { true, false, true }, [&dataList]() { ++dataList[2]; });
...
TEST_CASE("AnyId, default, map") {
    ...
    dispatcher.appendListener(3, [&dataList]() { ++dataList[0]; });
    dispatcher.appendListener(std::string("hello"), [&dataList]() { ++dataList[1]; });
    dispatcher.appendListener(std::vector<bool> { true, false, true }, [&dataList]() { ++dataList[2]; });
