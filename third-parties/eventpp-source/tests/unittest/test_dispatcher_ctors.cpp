...
TEST_CASE("EventDispatcher, copy constructor from non-empty EventDispatcher") {
    ...
    dispatcher.appendListener(event, [&dataList]() { ++dataList[1]; });
...
TEST_CASE("EventDispatcher, move constructor from non-empty EventDispatcher") {
    ...
    dispatcher.appendListener(event, [&dataList]() { ++dataList[0]; });
    dispatcher.appendListener(event, [&dataList]() { ++dataList[1]; });
    dispatcher.appendListener(event, [&dataList]() { ++dataList[2]; });
...
TEST_CASE("EventDispatcher, swap with non-empty EventDispatcher") {
    ...
    swappedDispatcher.appendListener(event, [&dataList]() { ++dataList[1]; });
    swappedDispatcher.appendListener(event, [&dataList]() { ++dataList[2]; });
