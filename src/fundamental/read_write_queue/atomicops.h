...
// Uses the AE_* prefix for macros (historical reasons), and the "Fundamental" namespace for symbols.
...
namespace Fundamental { inline int ae_tsan_global; }
#define AE_TSAN_ANNOTATE_RELEASE() AnnotateHappensBefore(__FILE__, __LINE__, (void *)(&::Fundamental::ae_tsan_global))
#define AE_TSAN_ANNOTATE_ACQUIRE() AnnotateHappensAfter(__FILE__, __LINE__, (void *)(&::Fundamental::ae_tsan_global))
