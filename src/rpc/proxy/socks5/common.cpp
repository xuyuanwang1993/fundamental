...
std::string dst_to_string(const std::vector<uint8_t>& dst_addr, Socks5HostType addr_type) {
    ...
    case Socks5HostType::Ipv6: {
        std::snprintf(addr, sizeof(addr),
                      ...
                      "02x:%02x%02x:%"
                      "02x%02x",
                      dst_addr[0], dst_addr[1], dst_addr[2], dst_addr[3], dst_addr[4], dst_addr[5], dst_addr[6],
                      dst_addr[7], dst_addr[8], dst_addr[9], dst_addr[10], dst_addr[11], dst_addr[12], dst_addr[13],
