...
namespace network {
namespace proxy {
void TrafficProxyManager::UpdateTrafficProxyHostInfo(const TrafficProxyDataType& serviceName,
...
bool TrafficProxyManager::GetTrafficProxyHostInfo(const TrafficProxyDataType& serviceName,
                                                  const TrafficProxyDataType& token, const TrafficProxyDataType& field,
